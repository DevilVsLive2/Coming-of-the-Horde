scope maxUpgrades initializer onInit requires CothUtilities
  ...
  private function onResearch takes nothing returns nothing
    ...
    elseif research == maxDamage or research == maxDamageGnome or research == maxDamageHorde then
    ...
    elseif research == armor or research == armorGnome or research == armorHorde then
      call SetPlayerTechMaxAllowed(GetTriggerPlayer(), maxArmor, 0)
    ...
    elseif research == damage or research == damageGnome or research == damageHorde then
      call SetPlayerTechMaxAllowed(GetTriggerPlayer(), maxDamage, 0)
