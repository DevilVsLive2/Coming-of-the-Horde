...
scope Sandbox initializer onInit
  ...
  private function SandboxInit takes nothing returns nothing
    ...
    set commands[0] = "|cffd88232-refresh:|r Сбрасывает перезарядку всех способностей, а так же восстанавливает всем войскам здоровье и ману.|n Можно добавлять аргументы: onlyability - сбрасывает только перезарядку всех способностей, onlyhp - восстанавливает всем только здоровье, onlymp - восстанавливает всем только ману, onlystats - восстанавливает всем здоровье и ману. Указать можно только 1 аргумент.|n"
    ...
    set commands[3] = "|cffd88232-editplayer:|r Позволяет менять ресурсы и состояния игрока, такие как сделать его врагом для определенного игрока или группы игроков, и тому подобное."
  ...
  private function SelectHero takes nothing returns nothing
    ...
    if GetClickedButton() == addNewHero.ownerOfHero[0] then
      call addNewHero.createAStromgardeHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[1] then
      call addNewHero.createAnAzerothHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[2] then
      call addNewHero.createAKulTirasHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[3] then
      call addNewHero.createADalaranHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[4] then
      call addNewHero.createADemonHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[5] then
      call addNewHero.createAGnomeHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[6] then
      call addNewHero.createAnElfHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[7] then
      call addNewHero.createAGilneasHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[8] then
      call addNewHero.createALordaeronHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[9] then
      call addNewHero.createAHordeStrengthHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[10] then
      call addNewHero.createAHordeAgilityHeroButtonList()
    elseif GetClickedButton() == addNewHero.ownerOfHero[11] then
  ...
  private function SelectPlayerOwnerOfHero takes nothing returns nothing
    ...
    loop
      call TriggerRegisterDialogButtonEvent(onDialogButtonClick, addNewUnit.ownerOfHero[i])
      set i = i + 1
  ...
  private function EditAllyState takes nothing returns nothing
    ...
    elseif (commandSoloIndex < commandEnemyIndex and commandSoloIndex < commandAllyIndex) and commandSoloIndex != -1 then //первая команда, что ввели это -solo
      ...
      call SetForceAllianceStateBJ(alliancePlayers, bj_FORCE_PLAYER[GetPlayerId(sandboxPlayer)], bj_ALLIANCE_ALLIED_ADVUNITS)
      call SetForceAllianceStateBJ(hordePlayers, bj_FORCE_PLAYER[GetPlayerId(sandboxPlayer)], bj_ALLIANCE_ALLIED_ADVUNITS)
    endif
  endfunction
  ...
  private function onInit takes nothing returns nothing
    ...
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-refresh", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-рефреш", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-куакуыр", false)
    call TriggerAddAction(trg, function Refresh)
    set trg = CreateTrigger()
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-addunit", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-фввгтше", false)
    call TriggerAddAction(trg, function AddNewUnit)
    set trg = CreateTrigger()
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-editunit", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-увшегтше", false)
    call TriggerAddAction(trg, function EditUnit)
    set trg = CreateTrigger()
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-editplayer", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-увшездфнук", false)
    call TriggerAddAction(trg, function EditPlayer)
    set trg = CreateTrigger()
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-enemy", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-утуьн", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-ally", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-фддн", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-solo", false)
    call CothUtilities_TriggerRegisterAnyPlayerChatEvent(trg, "-ыщдщ", false)
    call TriggerAddAction(trg, function EditAllyState)
